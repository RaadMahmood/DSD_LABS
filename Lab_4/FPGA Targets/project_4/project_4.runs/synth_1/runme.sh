...
HD_PWD='C:/Users/Raad Mahmood/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_4.tcl
