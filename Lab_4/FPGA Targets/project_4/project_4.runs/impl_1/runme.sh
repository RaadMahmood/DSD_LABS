...
HD_PWD='C:/Users/Raad Mahmood/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_4.tcl -notrace
